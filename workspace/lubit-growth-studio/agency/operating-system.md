...
4. `Content Strategist`, `Copywriter`, `Paid Media Specialist`, `Landing Page Builder` e `Analyst` executam seus blocos.
...
- mensal: revisão de templates, workflows e qualidade média da operação
